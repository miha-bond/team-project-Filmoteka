...
const STORAGE_LIBR_KEY2 = addToQueBtn.id;
   initStorage(STORAGE_LIBR_KEY1, parentContainer.id, document.querySelector('#watched'));
   initStorage(STORAGE_LIBR_KEY2, parentContainer.id, document.querySelector('#queue'));
     ...
     window.addEventListener('keydown', closeModalHandler);
      ...
      function onCloseBtn(e) {
         ...
         document.querySelector('#watched').removeEventListener('click', toggleToWatched);
